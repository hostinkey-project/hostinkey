...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Hostinkey server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Hostinkey server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hostinkey features */
        {"hostinkey", "masternode", &masternode, true, true, false},
        {"hostinkey", "listmasternodes", &listmasternodes, true, true, false},
        {"hostinkey", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hostinkey", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hostinkey", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hostinkey", "masternodedebug", &masternodedebug, true, true, false},
        {"hostinkey", "startmasternode", &startmasternode, true, true, false},
        {"hostinkey", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hostinkey", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hostinkey", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hostinkey", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hostinkey", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hostinkey", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hostinkey", "mnbudget", &mnbudget, true, true, false},
        {"hostinkey", "preparebudget", &preparebudget, true, true, false},
        {"hostinkey", "submitbudget", &submitbudget, true, true, false},
        {"hostinkey", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hostinkey", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hostinkey", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hostinkey", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hostinkey", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hostinkey", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hostinkey", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hostinkey", "checkbudgets", &checkbudgets, true, true, false},
        {"hostinkey", "mnsync", &mnsync, true, true, false},
        {"hostinkey", "spork", &spork, true, true, false},
        {"hostinkey", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hostinkey", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hostinkeyd, or the -server option to hostinkey-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hostinkey-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5911/\n";
}
