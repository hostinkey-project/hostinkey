...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hostinkey Core hostinkey-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hostinkey-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hostinkey transaction") + "\n" +
                               "  hostinkey-tx [options] -create [commands]   " + _("Create hex-encoded hostinkey transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hostinkey transaction
