                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hostinkey [XHK] v3 - Revotron") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hostinkey address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hostinkey: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXHK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hostinkey Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hostinkey Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hostinkey"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hostinkey addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hostinkey addresses"));
    ...
    openAction->setStatusTip(tr("Open a Hostinkey: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hostinkey Core help message to get a list with possible Hostinkey command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hostinkey Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hostinkey network", "", count));
}
...
{
    QString strTitle = tr("Hostinkey [XHK] v3 - Revotron"); // default title
