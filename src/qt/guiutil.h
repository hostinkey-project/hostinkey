...
/** Utility functions used by the Hostinkey Qt UI.
 */
namespace GUIUtil
{
...
// Render Hostinkey addresses in monospace font
...
// Parse "hostinkey:" URI into recipient object, return true on successful parsing
