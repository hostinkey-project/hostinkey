...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hostinkey [XHK] v3 - Revotron"),
     ...
     * override -datadir in the hostinkey.conf file in the default data directory
     * (to be consistent with hostinkeyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
