...
In order to support loading of multiple wallets in hostinkey-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hostinkey.cpp.
...
Changes to hostinkey.cpp
----------------------
hostinkey.cpp is the entry point into hostinkey-qt, and as such, will require some minor modifications to provide hooks for
