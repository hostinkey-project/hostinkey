Contributing to Hostinkey Core
============================

The Hostinkey Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hostinkey Core project, and is not to be
confused with overall Hostinkey Network Protocol consensus changes.

Whether a pull request is merged into Hostinkey Core rests with the project merge
...
Patches that change Hostinkey consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hostinkey consensus, it must have been
...
The project leader is the release manager for each Hostinkey Core release.
